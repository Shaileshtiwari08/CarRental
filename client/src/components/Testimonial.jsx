...
const Testimonial = () => {
    ...
    const testimonials = [
       ...
       {  
            ...
            image: assets.testimonial_image_1, 
            testimonial: "I highly recommend carRental! Their fleet is amazing, and I always feellike I'm getting the best deal with excellent service."
        }
    ];
                    ...
                    key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500">
                        ...
                        <div className="flex items-center gap-1 mt-4">
                            {Array(5).fill(0).map((_, index) => (
                                <img key={index} src={assets.star_icon} alt="star-icon" srcset="" />
